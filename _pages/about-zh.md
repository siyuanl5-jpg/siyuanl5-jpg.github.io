...
<p style="text-align: justify;">我是清华大学车辆与运载学院汽车碰撞试验室（ACL）的博士四年级研究生，导师为周青教授和聂冰冰副教授。同时，我也是卡耐基梅隆大学SafeAI Lab的访问学生与实习生，导师为赵鼎副教授。我的研究方向聚焦于面向自动驾驶安全评估的数字行人建模、测试场景生成、LLM价值匹配以及行人安全防护算法开发，具体包括：
<ul style="margin: 6px 0; padding-left: 40px;">
<li>3DGS交通场景下的行人危险行为生成；</li>
<li>动态博弈场景下LLM社会兼容性测评；</li>
...
<p style="text-align: justify;">目前，我正在卡耐基梅隆大学SafeAI Lab进行全职实习。我将于今年秋季进入求职市场，寻求全职职位！</p>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px; gap: 24px; padding: 16px 0 16px 20px; border-bottom: 1px solid #eee;">
  ...
  <div style="flex-shrink: 0;">
    <img src="/images/ITSM2026.png" style="width: 160px; border: 1px solid #ddd; border-radius: 4px; box-shadow: 2px 2px 6px rgba(0,0,0,0.1);" />
  </div>
</div>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px; gap: 24px; padding: 16px 0 16px 20px; border-bottom: 1px solid #eee;">
  ...
  <div style="flex-shrink: 0;">
    <img src="/images/TIP2025.png" style="width: 160px; border: 1px solid #ddd; border-radius: 4px; box-shadow: 2px 2px 6px rgba(0,0,0,0.1);" />
  </div>
</div>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px; gap: 24px; padding: 16px 0 16px 20px; border-bottom: 1px solid #eee;">
  ...
  <div style="flex-shrink: 0;">
    <img src="/images/AAP2026.png" style="width: 160px; border: 1px solid #ddd; border-radius: 4px; box-shadow: 2px 2px 6px rgba(0,0,0,0.1);" />
  </div>
</div>
